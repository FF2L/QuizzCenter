...
export default () :PostgresConnectionOptions => ({ //khai báo hàm trả về instance của PostgresConnectionOptions
    ...
    type: 'postgres',
    entities: [ThongBao, ThongBaoNguoiDung, NguoiDung, SinhVien, GiangVien, Khoa, MonHoc, LopHocPhan, DapAn,Chuong, CauHoi, BaiLamSinhVien,ChiTietBaiLam, BaiKiemTra, ChiTietCauHoiBaiKiemTra],
